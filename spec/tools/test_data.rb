module TestData
    ...
    def call_test_data
        ...
        @comment_1 = Comment.create(content: 'Comment 1', user: @user1, post: @post_with_comments)
        @comment_2 = Comment.create(content: 'Comment 2', user: @user1, post: @post_with_comments)
